...
export default async (req, res) => {
	...
	form.parse(req, async (err, fields, files) => {
		...
		const params = {
			Bucket: process.env.AWS_S3_BUCKET_NAME,
			Key: uploadedFile.newFilename, // Use the new filename generated by formidable
			Body: fileContent,
		...
		try {
			...
			const url = `https://${process.env.AWS_S3_BUCKET_NAME}.s3.${process.env.AWS_REGION}.amazonaws.com/${uploadedFile.newFilename}`;
